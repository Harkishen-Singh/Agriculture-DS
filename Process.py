...
class Process(Sorter):
    ...
    def processing_Good(self):
        ...
        file.save('./ratios/ratio_good_'+self.workbook_name2+'.xlsx')
    ...
    def processing_Normal(self):
                ...
                if checker == True:
                    if type(self.ws3.cell(row=no, column=10).value) == int:
                        ...
                        if type(seedExtractor2) != int and type(seedExtractor2) != float :
                            ...
                            number = ''
                            # print('p1 is ' + str(p1) + ' p2 is ' + str(p2))
                        if type(seedExtractor2) == int or type(seedExtractor2) == float :
                            p2 = seedExtractor2
                            # print('p1 is '+str(p1) + ' p2(int wala) is '+str(p2))
        ...
        file.save('./ratios/ratio_normal_'+self.workbook_name2+'.xlsx')
        self.processing_Bad()
    ...
    def processing_Bad(self):
        ...
        file.save('./ratios/ratio_bad_'+self.workbook_name2+'.xlsx')
